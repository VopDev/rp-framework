...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if LocalPlayer.state.LoggedIn then
            if Offsets ~= nil then
                if #(GetEntityCoords(PlayerPedId()) - vector3(Config.Apartment['Pos'].x + Offsets['Exit'].x, Config.Apartment['Pos'].y + Offsets['Exit'].y, (Config.Apartment['Pos'].z + 1000) + Offsets['Exit'].z)) < 1.5 then
                ...
                elseif #(GetEntityCoords(PlayerPedId()) - vector3(Config.Apartment['Pos'].x + Offsets['Stash'].x, Config.Apartment['Pos'].y + Offsets['Stash'].y, (Config.Apartment['Pos'].z + 1000) + Offsets['Stash'].z)) < 1.5 then
                    if not ShowingInteraction then
                ...
                elseif #(GetEntityCoords(PlayerPedId()) - vector3(Config.Apartment['Pos'].x + Offsets['Wardrobe'].x, Config.Apartment['Pos'].y + Offsets['Wardrobe'].y, (Config.Apartment['Pos'].z + 1000) + Offsets['Wardrobe'].z)) < 1.5 then
                    if not ShowingInteraction then
                ...
                elseif #(GetEntityCoords(PlayerPedId()) - vector3(Config.Apartment['Pos'].x + Offsets['Logout'].x, Config.Apartment['Pos'].y + Offsets['Logout'].y, (Config.Apartment['Pos'].z + 1000) + Offsets['Logout'].z)) < 1.5 then
                    if not ShowingInteraction then
...
RegisterNetEvent('mercy-apartment/client/spawn-apartment', function(NewChar)
    ...
    local Interior = exports['mercy-interiors']:CreateInterior('gabz_pinkcage', vector3(Config.Apartment['Pos'].x, Config.Apartment['Pos'].y, Config.Apartment['Pos'].z + 1000), false)
    if NewChar then 
    ...
    SetEntityCoords(PlayerPedId(), Config.Apartment['Pos'].x + Offsets['Sofa'].x, Config.Apartment['Pos'].y + Offsets['Sofa'].y, (Config.Apartment['Pos'].z + 1000) + Offsets['Sofa'].z)
...
RegisterNetEvent('mercy-apartment/client/enter-apartment', function(Data)
    ...
    SetEntityCoords(PlayerPedId(), Config.Apartment['Pos'].x + Offsets['Exit'].x, Config.Apartment['Pos'].y + Offsets['Exit'].y, (Config.Apartment['Pos'].z + 1000) + Offsets['Exit'].z)
